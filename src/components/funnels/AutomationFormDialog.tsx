            ...
            <div className="space-y-4">
              <div className="p-3 bg-primary/10 rounded-lg border border-primary/20">
                <p className="text-sm text-muted-foreground">
                  💰 Cria ou atualiza o cliente no Asaas (com o grupo configurado) e gera uma cobrança PIX com o valor do campo personalizado selecionado. A data de vencimento será lida de um campo do lead.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={actionConfig.value_field as string || ''}
                  onValueChange={(v) => setActionConfig({ ...actionConfig, value_field: v })}
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={actionConfig.group_field as string || ''}
                  onValueChange={(v) => setActionConfig({ ...actionConfig, group_field: v })}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Selecionar campo..." />
                  </SelectTrigger>
                ...
                <p className="text-xs text-muted-foreground">
                  O valor deste campo será usado como groupName no Asaas
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={actionConfig.due_date_field as string || ''}
                  onValueChange={(v) => setActionConfig({ ...actionConfig, due_date_field: v })}
                >
                  <SelectTrigger>
                ...
                <p className="text-xs text-muted-foreground">
                  Se não preenchido, usará a data de hoje + 3 dias
                </p>
              </div>
