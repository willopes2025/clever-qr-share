  ...
  const renderPreview = () => {
    ...
    return (
      <div className="relative p-3 bg-muted/30 rounded-lg border border-border">
        ...
        {mediaType === 'document' && (
          <div className="flex items-center gap-3">
            <div className="h-16 w-14 rounded bg-red-500/10 border border-red-500/20 flex items-center justify-center">
  ...
  return (
    <div className="space-y-3">
      ...
      {isUploading ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2">
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground">até 20MB</span>
          </Button>
      ...
      <p className="text-xs text-muted-foreground">
        Formatos aceitos: JPG, PNG, GIF, MP4, OGG (áudio WhatsApp), MP3, PDF
      </p>
