            ...
            {pricingTiers.map((tier, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className={`p-8 h-full flex flex-col ${tier.highlighted ? 'elevated-card ring-2 ring-accent' : 'depth-card'}`}>
                    <div className="flex items-center gap-3 mb-4">
                      <div className={`h-12 w-12 rounded-xl flex items-center justify-center ${tier.highlighted ? 'bg-gradient-to-br from-primary to-accent' : 'bg-muted'}`}>
