      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Crie e gerencie templates internos e templates Meta WhatsApp
          </p>
        </div>
      </div>

      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'internal' | 'meta')}>
        <TabsList className="bg-dark-800/50 border border-neon-cyan/30">
          <TabsTrigger value="internal" className="data-[state=active]:bg-neon-cyan/20">
            <FileText className="h-4 w-4 mr-2" />
            Templates Internos
          </TabsTrigger>
          <TabsTrigger value="meta" className="data-[state=active]:bg-neon-cyan/20">
