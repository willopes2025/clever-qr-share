...
const PRODUCT_TO_PLAN: Record<string, PlanInfo> = {
  ...
  "prod_Tg5rhArqyzOqTt": { plan: "avancado", maxInstances: 50, maxContacts: null, maxMessages: null, maxLeads: 20000 },
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    logStep("ERROR", { message: errorMessage, status: isAuthError ? 401 : 500 });
